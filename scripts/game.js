//ik weet dat deze is een andere manier om het spel te programeren(ik vind t minder lastig) deze manier heb ik van een youtyouber gelerd
...
// background en ander imgs
  ...
  class Scene2 extends Phaser.Scene{
     ...
     create() {
        ...
        this.platform2 = this.physics.add.image(200,200 , 'platform').setScale(1.4);
        this.setplatform(this.platform2);
...
// hoeveel mag je sprinten
    ...
    myfunction(){
        gameOptions.Speed+=0.30*this.do;
